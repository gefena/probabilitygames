...
2. A comparison label (e.g. "That's bigger than the number of stars in the Milky Way!" for hard mode 8-char full password)
...
Same as guess-phone-game: up to 10 most recent guesses as chips showing position, character, and ✓/✗.
...
Identical to guess-phone-game: Give Up reveals the secret before resetting; New Game resets without changing length/difficulty settings.
