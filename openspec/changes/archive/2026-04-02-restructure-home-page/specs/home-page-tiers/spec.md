...
### Requirement: Tier 1 — Start Here (five simple interactive games)
The first tier SHALL contain Coin Flip, Lucky Dice, Candy Jar, Magic Spinner, and Card Draw — the five most direct single-interaction games.

#### Scenario: Start Here contains the five simple games
- **WHEN** a user views the Start Here tier
- **THEN** cards for Coin Flip, Lucky Dice, Candy Jar, Magic Spinner, and Card Draw are visible

### Requirement: Tier 2 — Go Deeper (strategy and decision games)
The second tier SHALL contain Greedy Pig, House Always Wins, Lucky Combo, and Prize Machine.

#### Scenario: Go Deeper contains the four strategy games
- **WHEN** a user views the Go Deeper tier
- **THEN** cards for Greedy Pig, House Always Wins, Lucky Combo, and Prize Machine are visible
...
The fourth tier SHALL contain Galton Board, Random Walk, Monte Carlo π, Monty Hall, Birthday Room, and Mystery Machine. The tier SHALL use a dark background panel.

#### Scenario: Patterns in Chaos contains all six simulation games
- **WHEN** a user views the Patterns in Chaos tier
- **THEN** cards for Galton Board, Random Walk, Monte Carlo π, Monty Hall, Birthday Room, and Mystery Machine are visible
