...
All quiz question text, option labels, and explanations SHALL be stored as i18n keys in both en.json and he.json under the `houseAlwaysWins.quiz.*` namespace.
